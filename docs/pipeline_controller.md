...
A cold-start guide for anyone (human or a fresh agent session — Claude Code,
Codex, or other) building automation on top of icepick's pipeline. Assumes you have shell access
